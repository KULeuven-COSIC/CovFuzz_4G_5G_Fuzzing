...
sub read_repo_info {
	...
	my $git_archive_commit = '4b0da63a89299b1d902f9aa32dfade2b5f3e948f';
	my @git_refs = split(/, /, 'HEAD -> wdissector, refs/keep-around/4b0da63a89299b1d902f9aa32dfade2b5f3e948f');
